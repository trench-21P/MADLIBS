...
const submitMadLibs = (event) => {
    ...
    const story = `
        ...
        <p>
        Winter is one of <span class="inserted-text">${userSubmission.number}</span> seasons of the year. 
        ...
        Hot <span class="inserted-text">${userSubmission.beverage}</span>
         with <span class="inserted-text">${userSubmission.food}</span> on top is a popular winter drink.
        </p>
    `;
